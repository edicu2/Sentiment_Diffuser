...
public class SliderAdapter extends PagerAdapter{
    ...
    public SliderAdapter(Context context, ArrayList<ArrayList> itemList, ArrayList<int[]> itemList2){
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Log.i("item2", toString().valueOf(item2));
