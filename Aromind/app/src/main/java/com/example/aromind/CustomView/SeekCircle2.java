...
public class SeekCircle2 extends ProgressCircle2 {
    /**
    ...
    public interface OnSeekCircleChangeListener {
         ...
         */
        void onProgressChanged(SeekCircle2 seekCircle, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(SeekCircle2 seekCircle);
         ...
         * @param seekCircle The SeekCircle in which the touch gesture began
         */
        void onStopTrackingTouch(SeekCircle2 seekCircle);
    }
     ...
     * @see SeekCircle2.OnSeekCircleChangeListener
     */
    ...
    public SeekCircle2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SeekCircle2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SeekCircle2(Context context) {
        super(context);
    }
