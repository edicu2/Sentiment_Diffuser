...
public class SeekCircle1 extends ProgressCircle1 {
    /**
    ...
    public interface OnSeekCircleChangeListener {
         ...
         */
        void onProgressChanged(SeekCircle1 seekCircle, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(SeekCircle1 seekCircle);
         ...
         * @param seekCircle The SeekCircle in which the touch gesture began
         */
        void onStopTrackingTouch(SeekCircle1 seekCircle);
    }
     ...
     * @see SeekCircle1.OnSeekCircleChangeListener
     */
    ...
    public SeekCircle1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SeekCircle1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SeekCircle1(Context context) {
        super(context);
    }
