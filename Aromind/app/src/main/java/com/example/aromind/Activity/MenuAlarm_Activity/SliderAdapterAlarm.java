...
public class SliderAdapterAlarm extends PagerAdapter {
    ...
    private View v;
    private Popup_alarmCustomCard activity;


    private Custom_power_DBHelper custom_powerDB;
    private Custom_gradient_DBHelper custom_gradient_DB;

    public SliderAdapterAlarm(Popup_alarmCustomCard activity, Context context, ArrayList<ArrayList> itemList, ArrayList<int[]> itemList2, ArrayList<String> title){
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        v = inflater.inflate(R.layout.item_slider_alarm, container, false);
